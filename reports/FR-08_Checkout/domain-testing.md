...
| ----- | ---------------------------------------- | ---------------- | ----------------- | --------------- | ---------------- | ----------------------------------------------------- | --------------- | --------- |
| TC-01 | Checkout thành công đầy đủ thông tin     | A1 logged in     | C1 có hàng        | T1 backend tính | U1 đầy đủ        | Thanh toán thành công, giỏ hàng xóa, lịch sử cập nhật |                 |           |
| TC-02 | Chưa đăng nhập vào trang checkout        | A2 not logged in | C1 có hàng        | -               | -                | Redirect về `/login`                                  |                 |           |
| TC-03 | Giỏ hàng rỗng                            | A1 logged in     | C2 rỗng           | -               | U1 đầy đủ        | Báo giỏ hàng trống, không cho checkout                |                 |           |
| TC-04 | Giỏ hàng 1 sản phẩm                      | A1 logged in     | C3 1 sản phẩm     | T1 backend tính | U1 đầy đủ        | Hiển thị đúng 1 sản phẩm, tổng tiền đúng              |                 |           |
| TC-05 | Giỏ hàng nhiều sản phẩm                  | A1 logged in     | C4 nhiều sản phẩm | T1 backend tính | U1 đầy đủ        | Hiển thị đầy đủ, tổng tiền đúng                       |                 |           |
| TC-06 | Client tự sửa total_amount trên UI       | A1 logged in     | C1 có hàng        | T2 client sửa   | U1 đầy đủ        | Backend tính lại đúng, không dùng giá trị client gửi  |                 |           |
| TC-07 | Client gửi total_amount = 0              | A1 logged in     | C1 có hàng        | T3 = 0          | U1 đầy đủ        | Backend tính lại đúng, không chấp nhận 0              |                 |           |
| TC-08 | Client gửi total_amount âm               | A1 logged in     | C1 có hàng        | T4 âm           | U1 đầy đủ        | Backend tính lại đúng, không chấp nhận giá trị âm     |                 |           |
| TC-09 | Thiếu địa chỉ vẫn checkout               | A1 logged in     | C1 có hàng        | T1 backend tính | U2 thiếu địa chỉ | Báo lỗi thiếu địa chỉ                                 |                 |           |
| TC-10 | Thiếu SĐT vẫn checkout                   | A1 logged in     | C1 có hàng        | T1 backend tính | U3 thiếu SĐT     | Báo lỗi thiếu SĐT                                     |                 |           |
| TC-11 | Thiếu cả địa chỉ lẫn SĐT                 | A1 logged in     | C1 có hàng        | T1 backend tính | U4 thiếu hết     | Báo lỗi thiếu thông tin                               |                 |           |
| TC-12 | Sau checkout thành công giỏ hàng xóa     | A1 logged in     | C1 có hàng        | T1 backend tính | U1 đầy đủ        | Giỏ hàng = rỗng sau khi thanh toán                    |                 |           |
| TC-13 | Sau checkout thành công lịch sử cập nhật | A1 logged in     | C1 có hàng        | T1 backend tính | U1 đầy đủ        | Đơn hàng xuất hiện trong lịch sử                      |                 |           |
| TC-14 | Tổng tiền hiển thị đúng với giỏ hàng     | A1 logged in     | C4 nhiều sản phẩm | T1 backend tính | U1 đầy đủ        | Tổng tiền = sum(giá × số lượng từng sản phẩm)         |                 |           |
